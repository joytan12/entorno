...
import (
	...
	pb "Servidor3/proto" // Asegúrate de que sea el path correcto generado a partir del .proto

	"google.golang.org/grpc"
)

const (
	port = ":8084" // Puerto donde escucha el Servidor 3
)
...
func main() {
	...
	log.Printf("Servidor 3 escuchando en el puerto %s", port[1:])
