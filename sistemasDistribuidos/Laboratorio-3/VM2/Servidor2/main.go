...
import (
	...
	pb "Servidor2/proto" // Asegúrate de que sea el path correcto generado a partir del .proto

	"google.golang.org/grpc"
)

const (
	port = ":8083" // Puerto donde escucha el Servidor 2
)
...
func main() {
	...
	log.Printf("Servidor 2 escuchando en el puerto %s", port[1:])
