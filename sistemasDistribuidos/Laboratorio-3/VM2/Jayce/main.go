...
import (
	...
	pb "Jayce/proto" // Asegúrate de que sea el path correcto generado a partir del .proto

	"google.golang.org/grpc"
)

const (
	port = ":8081" // Puerto donde escucha Jayce
)
...
func main() {
	...
	log.Printf("Jayce escuchando en el puerto %s", port[1:])
