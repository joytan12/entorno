...
import (
	...
	pb "Supervisor1/proto" // Asegúrate de que sea el path correcto generado a partir del .proto

	"google.golang.org/grpc"
)

const (
	port = ":8085" // Puerto donde escucha el Supervisor 1
)
...
func main() {
	...
	log.Printf("Supervisor 1 escuchando en el puerto %s", port[1:])
