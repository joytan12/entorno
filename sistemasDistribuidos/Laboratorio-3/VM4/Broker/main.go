...
import (
	...
	pb "Broker/proto" // Asegúrate de que sea el path correcto generado a partir del .proto

	"google.golang.org/grpc"
)

const (
	port = ":8080" // Puerto donde escucha el Broker
)
...
func main() {
	...
	log.Printf("Broker escuchando en el puerto %s", port[1:])
