...
import (
	...
	pb "DataNode2/proto" // Asegúrate de que sea el path correcto generado a partir del .proto
)

const (
	port = ":8082" // Puerto donde escucha el Data Node
)
...
func (s *server) GetDigimonStatus(ctx context.Context, req *pb.DigimonRequest) (*pb.DigimonResponse, error) {
	...
	if req.Opt == "-1" {
		fmt.Println("Apagando DataNode2")
		os.Exit(0)
	}
